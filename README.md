...
local Tab1 = Library:CreateTab("AutoFarm")
local Tab1 = Library:CreateTab("Stats")
local Tab1 = Library:CreateTab("Setting AutoFarm")
local Tab1 = Library:CreateTab("️Players")
local Tab1 = Library:CreateTab("Teleport")
local Tab1 = Library:CreateTab("Mics")
local Tab1 = Library:CreateTab("Dunguen")
local Tab1 = Library:CreateTab("BuyItem")
local Tab1 = Library:CreateTab("Setting")
